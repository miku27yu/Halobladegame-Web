    ...
    var characters = {
        ...
        starRunners: {
            ...
            tags: [
                ...
                { label: '青川弘一', img: IMG + 'c2.jpeg', text: '“惊霆”青川弘一，猎影者执行部远东局总长，五阶执行官，王爵级中阶，追猎者刃卫荣誉头衔拥有者，岩山大将军。继承古老家格的惊霆王爵同时身负伟大命运和深重诅咒，在遍历大陆的浪人生涯中他将在每一个十字路口做出黑暗或光明的艰难抉择，始终以手中之剑印证心中之道。' },
                { label: '穆越', img: IMG + 'c3.jpeg', text: '“溯风神剑”穆越，栖桐台执行部南洋局总长，五阶执行官，王爵级中阶，追猎者刃卫荣誉头衔拥有者，清州公。崇高、强大和无私精神在菁英一代年轻执行官中的化身，自幼受到沉重责任束缚的他从未真正将任何与己相关的事物放在首位，即便身心俱疲也始终得体且坚韧地用言辞与刀剑同任何异己抗争。' },
                { label: '凯伊兰·费雅图瑞', img: IMG + 'c4.jpeg', text: '“银辉”凯伊兰·费雅图瑞，风暴公使执行部五阶执行官，王爵级中阶，追猎者刃卫荣誉头衔拥有者，艾多雷斯帝国公主。相比于凌厉的能力锋芒，优雅美丽的外表只是这位年轻兰希族公主最微不足道的特质。在了却权斗驳杂后，她如今更倾向于将热爱和忠诚投注于挚友艾卡纳罗和其团队的伟大事业中。' },
